        ...
        <div class="patients">
          ...
          <div class="vue">
            <div class="addCard">
              ...
              <p style="font-size: 12px; opacity: 0.7; text-align: center; margin-top: 10px">
                Etatpe 1/4
              </p>
              <div class="contenu">
                ...
                <form>
                  ...
                  <div class="liens">
                    <button id="submit" type="submit">
                      <RouterLink to="/patients"><p id="tex">Annuler</p></RouterLink>
                    </button>

                    <button id="submit" type="submit" @click="set_one">
                      <RouterLink to="/etape-2"><p id="tex">Suivant</p></RouterLink>
                    </button>
                  </div>
                </form>
              </div>
...
export default {
  data() {
    return {
      ...
      nom: localStorage.getItem('last_name') ? localStorage.getItem('last_name') : "",
      prenom: localStorage.getItem('first_name') ? localStorage.getItem('first_name') : "",
  ...
  methods: {
    set_one() {
      localStorage.setItem('last_name', this.nom), localStorage.setItem('first_name', this.prenom)
    }
  }
}
</script>
